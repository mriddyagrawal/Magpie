...
**It isn't:**
- A cloud-sync service. Files don't leave your machine (aside from the small summaries sent to the LLM for embedding, and the vectors stored in Qdrant Cloud).
