...
These extensions take the **same** code path: `.py`, `.js`, `.ts`, `.tsx`, `.jsx`, `.go`, `.rs`, `.java`, `.cpp`, `.h`, `.hpp`, `.cs`, `.rb`, `.swift`, `.kt`, `.sh`, `.sql`.

## Flowchart

```mermaid
flowchart TD
    A["File: example.c"] --> B{"In .gitignore /<br/>.nasignore /<br/>default-ignore?"}
