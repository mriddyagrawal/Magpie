...
These extensions take the **same** code path: `.py`, `.js`, `.ts`, `.tsx`, `.go`, `.rs`, `.java`, `.c`, `.cpp`, `.h`, `.hpp`, `.cs`, `.rb`, `.swift`, `.kt`, `.sh`, `.sql`.

## Flowchart

```mermaid
flowchart TD
    A["File: example.jsx"] --> B{"In .gitignore /<br/>.nasignore /<br/>default-ignore?"}
