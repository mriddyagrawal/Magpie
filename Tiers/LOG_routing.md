...
These extensions take the **same** code path (only the extension token differs): `.txt`, `.md`, `.markdown`.

## Flowchart

```mermaid
flowchart TD
    A["File: example.log"] --> B{"In .gitignore /<br/>.nasignore /<br/>default-ignore?"}
