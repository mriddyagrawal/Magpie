...
These extensions take the **same** code path (only the extension token differs): `.txt`, `.markdown`, `.log`.

## Flowchart

```mermaid
flowchart TD
    A["File: example.md"] --> B{"In .gitignore /<br/>.nasignore /<br/>default-ignore?"}
