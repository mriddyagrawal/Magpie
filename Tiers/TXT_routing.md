...
These extensions take the **same** code path (only the extension token differs): `.md`, `.markdown`, `.log`.

## Flowchart

```mermaid
flowchart TD
    A["File: example.txt"] --> B{"In .gitignore /<br/>.nasignore /<br/>default-ignore?"}
