# Eval report — 20260906T090247Z-custom_dataset_rahul_Aug30-custom-rahul-topk2-rerank-off-norewrite
...
Config `custom-rahul-topk2-rerank-off-norewrite` · dataset `custom_dataset_rahul_Aug30` · 120 questions · backend `92f9ba947262`

## Headline

| Metric | Value |
|---|---:|
| Correct (answerable, deterministic) | 0.038 |
| Partial | 0.163 |
| Wrong | 0.365 |
| False abstain | 0.433 |
...
| nDCG@5 | 0.9204761652869531 |
| Citation precision / recall | 0.1875 / 0.20566239316239315 |
| Solo-gate fire rate | 0.05 |
| Latency p50 / p95 (s) | 13.9 / 41.9 |
...
- non-abstain answers returned with ZERO cited sources: 28
...
- **phone-05-typed** [wrong] hit@5=1.0 gate=False facts=0/7 err=-
