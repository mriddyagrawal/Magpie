# Eval report — 20260906T103913Z-custom_dataset_rahul_Aug30-custom-rahul-topk2-rerank-off-norewrite
...
Config `custom-rahul-topk2-rerank-off-norewrite` · dataset `custom_dataset_rahul_Aug30` · 120 questions · backend `4ce90a80d874`

## Headline

| Metric | Value |
|---|---:|
| Correct (answerable, deterministic) | 0.154 |
| Partial | 0.308 |
| Wrong | 0.192 |
| False abstain | 0.346 |
| Correct abstain (of 16 not_found) | 0.875 |
| False answer on not_found | 0.125 |
...
| nDCG@5 | 0.9203694446126552 |
| Citation precision / recall | 0.13942307692307693 / 0.10683760683760683 |
| Solo-gate fire rate | 0.05 |
| Latency p50 / p95 (s) | 15.3 / 43.7 |

## H1 slice (per-arm; never compare raw across arms)

- extractive n=70, eligible n=49 (0.7) — basis: {'fact_spans': 0, 'file_level_image': 49}
- accuracy by basis: {'file_level_image': 0.184} | combined: 0.184
...
- non-abstain answers returned with ZERO cited sources: 49

## Failures (deterministic verdicts)

- **viz-01-typed** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **viz-02-typed** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **viz-02-full** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **viz-03-typed** [partial] hit@5=1.0 gate=False facts=1/3 err=-
- **viz-03-full** [partial] hit@5=1.0 gate=False facts=2/3 err=-
- **viz-04-typed** [partial] hit@5=1.0 gate=False facts=1/4 err=-
- **viz-04-full** [false_abstain] hit@5=1.0 gate=False facts=0/4 err=-
...
- **viz-07-typed** [wrong] hit@5=1.0 gate=False facts=0/4 err=-
...
- **arch-01-typed** [wrong] hit@5=1.0 gate=False facts=0/1 err=-
- **arch-01-full** [false_abstain] hit@5=1.0 gate=False facts=0/1 err=-
- **arch-02-typed** [false_abstain] hit@5=1.0 gate=False facts=0/1 err=-
...
- **arch-05-typed** [false_abstain] hit@5=1.0 gate=False facts=0/2 err=-
- **arch-05-full** [false_abstain] hit@5=1.0 gate=False facts=0/2 err=-
- **arch-06-typed** [false_abstain] hit@5=1.0 gate=True facts=0/2 err=-
...
- **arch-08-typed** [partial] hit@5=1.0 gate=False facts=2/3 err=-
- **arch-08-full** [partial] hit@5=1.0 gate=False facts=2/3 err=-
- **arch-09-typed** [wrong] hit@5=1.0 gate=False facts=0/2 err=-
...
- **study-01-full** [partial] hit@5=1.0 gate=False facts=3/4 err=-
- **study-02-typed** [wrong] hit@5=1.0 gate=False facts=0/8 err=-
- **study-03-typed** [false_abstain] hit@5=1.0 gate=True facts=0/5 err=-
- **study-03-full** [false_abstain] hit@5=1.0 gate=False facts=0/5 err=-
- **study-04-typed** [wrong] hit@5=1.0 gate=False facts=0/5 err=-
- **study-04-full** [partial] hit@5=1.0 gate=False facts=1/5 err=-
- **study-05-typed** [wrong] hit@5=0.0 gate=False facts=0/5 err=-
- **study-05-full** [false_abstain] hit@5=0.0 gate=False facts=0/5 err=-
- **study-06-typed** [false_abstain] hit@5=1.0 gate=False facts=0/5 err=-
...
- **study-08-full** [false_abstain] hit@5=1.0 gate=True facts=0/6 err=-
...
- **study-10-full** [false_abstain] hit@5=0.0 gate=False facts=0/6 err=-
- **study-11-typed** [wrong] hit@5=1.0 gate=False facts=0/4 err=-
- **study-11-full** [wrong] hit@5=1.0 gate=False facts=0/4 err=-
...
- **rcpt-02-typed** [partial] hit@5=1.0 gate=False facts=1/5 err=-
...
- **rcpt-08-typed** [partial] hit@5=1.0 gate=False facts=1/4 err=-
- **rcpt-08-full** [wrong] hit@5=1.0 gate=False facts=0/4 err=-
- **rcpt-09-typed** [false_abstain] hit@5=1.0 gate=False facts=0/5 err=-
...
- **phone-08-typed** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **phone-10-typed** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **phone-10-full** [partial] hit@5=1.0 gate=False facts=1/2 err=-
- **phone-11-typed** [partial] hit@5=1.0 gate=False facts=1/3 err=-
- **phone-11-full** [partial] hit@5=1.0 gate=False facts=2/3 err=-
- **nf-03-typed** [false_answer] hit@5=None gate=False facts=0/0 err=-
